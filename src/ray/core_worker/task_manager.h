...
class TaskManager : public TaskFinisherInterface, public TaskResubmissionInterface {
 public:
  TaskManager(std::shared_ptr<CoreWorkerMemoryStore> in_memory_store,
              ...
              std::function<bool (const ActorID &, const ObjectID &, const std::vector<std::shared_ptr<RayObject>> &, std::shared_ptr<RayObject> *)> on_object_failure)
 ...
 private:
  ...
  std::function<bool (const ActorID &, const ObjectID &, const std::vector<std::shared_ptr<RayObject>> &, std::shared_ptr<RayObject> *)> on_object_failure_;
